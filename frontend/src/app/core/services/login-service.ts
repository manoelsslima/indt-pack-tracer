...
export class LoginService {
  ...
  user3: User = { id: 'gabriel.vinicius', grupo: 2, name: 'Gabriel Vinicius', password: 'gabriel', setorId: 8 };
  user4: User = { id: 'allan.resutto', grupo: 1, name: 'Allan Resutto', password: 'allan' , setorId: 7};
  user5: User = { id: 'victor.santos', grupo: 3, name: 'Victor Santos', password: 'victor', setorId: 1 };
